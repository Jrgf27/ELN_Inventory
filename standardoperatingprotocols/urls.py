...
urlpatterns = [
    ...
    path('htmx/create-attachment-form/<int:id>', views.CreateAttachmentForm.as_view(), name='create-attachment-form_SOP'),
    ...
    path('htmx/create-trainer-form/<int:id>', views.CreateSOPTrainerForm.as_view(), name='create-SOPTrainer-form'),
    ...
    path('htmx/create-trainee-form/<int:id>', views.CreateSOPTraineeForm.as_view(), name='create-SOPTrainee-form'),
